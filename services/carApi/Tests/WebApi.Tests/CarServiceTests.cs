...
public class CarIntegrationTests : IClassFixture<FactoryFixture>
{
    private readonly FactoryFixture _fixture;
    private readonly ITestOutputHelper _output;

    public CarIntegrationTests(FactoryFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
    }
    ...
    public async Task Crud_WithAuth_ShouldWork()
    {
        ...
        if (!uint.TryParse(content, out var carId)) Assert.Fail();
